...
#ifndef __Thea_CsparseSymbolVisibility_hpp__
#define __Thea_CsparseSymbolVisibility_hpp__
...
#    define THEA_CSPARSE_IMPORT  __declspec(dllimport)
#    define THEA_CSPARSE_EXPORT  __declspec(dllexport)
#    define THEA_CSPARSE_DLL_LOCAL
#    define THEA_CSPARSE_DLL_PUBLIC
#else
#    if (defined __GNUC__ && __GNUC__ >= 4)
#        define THEA_CSPARSE_IMPORT      __attribute__ ((visibility("default")))
#        define THEA_CSPARSE_EXPORT      __attribute__ ((visibility("default")))
#        define THEA_CSPARSE_DLL_LOCAL   __attribute__ ((visibility("hidden")))
#        define THEA_CSPARSE_DLL_PUBLIC  __attribute__ ((visibility("default")))
#    else
#        define THEA_CSPARSE_IMPORT
#        define THEA_CSPARSE_EXPORT
#        define THEA_CSPARSE_DLL_LOCAL
#        define THEA_CSPARSE_DLL_PUBLIC
#    endif
#endif

// Build flags for the Thea CSPARSE plugin (if any).
#ifdef THEA_CSPARSE_DLL
#    ifdef THEA_CSPARSE_DLL_EXPORTS
#        define THEA_CSPARSE_API  THEA_CSPARSE_EXPORT
#    else
#        define THEA_CSPARSE_API  THEA_CSPARSE_IMPORT
#    endif
#else
#    define THEA_CSPARSE_API
#endif
