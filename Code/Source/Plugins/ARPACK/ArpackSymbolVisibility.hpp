...
#ifndef __Thea_ArpackSymbolVisibility_hpp__
#define __Thea_ArpackSymbolVisibility_hpp__
...
#    define THEA_ARPACK_IMPORT  __declspec(dllimport)
#    define THEA_ARPACK_EXPORT  __declspec(dllexport)
#    define THEA_ARPACK_DLL_LOCAL
#    define THEA_ARPACK_DLL_PUBLIC
#else
#    if (defined __GNUC__ && __GNUC__ >= 4)
#        define THEA_ARPACK_IMPORT      __attribute__ ((visibility("default")))
#        define THEA_ARPACK_EXPORT      __attribute__ ((visibility("default")))
#        define THEA_ARPACK_DLL_LOCAL   __attribute__ ((visibility("hidden")))
#        define THEA_ARPACK_DLL_PUBLIC  __attribute__ ((visibility("default")))
#    else
#        define THEA_ARPACK_IMPORT
#        define THEA_ARPACK_EXPORT
#        define THEA_ARPACK_DLL_LOCAL
#        define THEA_ARPACK_DLL_PUBLIC
#    endif
#endif

// Build flags for the Thea ARPACK plugin (if any).
#ifdef THEA_ARPACK_DLL
#    ifdef THEA_ARPACK_DLL_EXPORTS
#        define THEA_ARPACK_API  THEA_ARPACK_EXPORT
#    else
#        define THEA_ARPACK_API  THEA_ARPACK_IMPORT
#    endif
#else
#    define THEA_ARPACK_API
#endif
