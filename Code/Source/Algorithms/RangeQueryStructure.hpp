...
class /* THEA_API */ RangeQueryStructure
{
  public:
    ...
    /**
     * Get all elements intersecting a range.
     *
     * @param range The range to search in.
     * @param result The elements intersecting the range are stored here.
     * @param discard_prior_results If true, the contents of \a results are cleared before the range query proceeds. If false,
     *   the previous results are retained and new elements are appended to the array (this is useful for range queries over a
    ...
    /**
     * Get the indices of all elements intersecting a range.
     *
     * @param range The range to search in.
     * @param result The indices of elements intersecting the range are stored here.
     * @param discard_prior_results If true, the contents of \a results are cleared before the range query proceeds. If false,
     *   the previous results are retained and indices of new elements are appended to the array (this is useful for range
