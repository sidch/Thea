...
class SpinImage : public SampledSurface<ExternalSampleKdTreeT>
{
  ...
  public:
    ...
    SpinImage(MeshT const & mesh, intx num_samples = -1, bool smooth = false, Real normalization_scale = -1)
     ...
     */
    template <typename MeshT>
    SpinImage(Graphics::MeshGroup<MeshT> const & mesh_group, intx num_samples = -1, bool smooth = false,
