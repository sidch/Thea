...
# Dependency: G3D
IF(Thea_FIND_G3D)
  IF(EXISTS ${THEA_INSTALLATIONS_ROOT}/installed-g3d)
    SET(G3D_ROOT ${THEA_INSTALLATIONS_ROOT}/installed-g3d)
  ELSE()
    SET(G3D_ROOT ${THEA_INSTALLATIONS_ROOT})
  ENDIF()
  FIND_PACKAGE(G3D REQUIRED)
  FIND_PACKAGE(Threads REQUIRED)
  LIST(APPEND G3D_LIBRARIES ${CMAKE_THREAD_LIBS_INIT})
ENDIF()
